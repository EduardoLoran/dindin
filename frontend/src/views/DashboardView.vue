...
const monthExists = computed(() => dashboard.value?.months?.some((item) => item.monthKey === selectedMonth.value));
const currentSalaryAction = computed(() => month.value?.salaryDefined ? "Editar salário" : "Cadastrar salário");
